        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            <button onClick={goToCases}
              className="h-fit px-4 py-3 bg-[var(--color-primary)] text-white rounded-2xl shadow-md border border-[var(--color-primary)] hover:bg-transparent hover:shadow-lg duration-300 hover:text-[var(--color-primary)] transition-all hover:cursor-pointer">
              Explore Cases
              <Icon className="inline ml-2 w-4 h-4" icon="tabler:arrow-right" />
            </button>
            <a href='#howitworks'>
              <button
              className="h-fit px-6 py-3 rounded-2xl border-2 border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white duration-300 transition-all hover:cursor-pointer shadow-md hover:shadow-lg">
              How It Works
            </button>
            </a>
          </div>
